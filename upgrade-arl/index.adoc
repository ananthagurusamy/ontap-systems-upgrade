...
You can use this procedure to upgrade an AFF controller or an AFF All SAN Array (ASA) configuration to an ASA controller for certain models and ONTAP software versions. link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-affa900/index.html[Learn more].
|9.8 or later
