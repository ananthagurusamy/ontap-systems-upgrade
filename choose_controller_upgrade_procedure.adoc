...
*Note3*: When upgrading by moving volumes, you add the new nodes and then uninstall the nodes you want to remove from the cluster. If the system you are upgrading is a two-node switchless cluster, you will need a pair of cluster switches.
====
