...
. Go to the https://mysupport.netapp.com/site/products/all/details/metrocluster-rcf/downloads-tab[MetroCluster RCF^] page and select the RCFs for your switch configuration.
+
You must use the RCFs that match your switch model.
+
For information on FC switch RCF installations in a fabric-attached MetroCluster configuration, select the link for your switch model type:
