...
summary: "Move node1 NAS data LIFs to node2 if you have a two-node cluster, or to a third node if your cluster has more than two nodes, during a manual ARL upgrade on controllers running ONTAP 9.7 or earlier."
---
