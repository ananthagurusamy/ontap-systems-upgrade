...
If your storage configuration includes SAN volumes or encrypted volumes, for example, when performing a mixed version cluster upgrade, you must also move these volumes:
