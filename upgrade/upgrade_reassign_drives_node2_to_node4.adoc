...
[.lead]
After converting AFF A250 node2 to an NS224 drive shelf and connecting to AFF A400 node4, you must reassign the drives previously belonged to node2 to node4. 

.Before you begin
Verify that both node2 and node4 are on standby at the LOADER prompt.
