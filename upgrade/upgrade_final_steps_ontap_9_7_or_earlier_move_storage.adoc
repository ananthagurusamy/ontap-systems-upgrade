...
.Before you begin
These steps apply to systems running ONTAP 9.7 or earlier. If you are running ONTAP 9.8 or later, you must use the procedure in xref:upgrade-final-upgrade-steps-in-ontap-9-8.adoc[Perform the final upgrade steps in ONTAP 9.8 or later].

.Steps
. If your system is running ONTAP 9.8 or later, *STOP*. You must use the procedure in xref:upgrade-final-upgrade-steps-in-ontap-9-8.adoc[Perform final upgrade steps in ONTAP 9.8 or later].
