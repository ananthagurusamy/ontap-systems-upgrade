...
Models with internal drives are listed in the table below. 

[cols=3*,options="header"]
|===
3+h|Models with internal drives
...
* If your system is not listed in the table above, see the https://hwu.netapp.com[NetApp Hardware Universe^] to check if it has internal drives. 
