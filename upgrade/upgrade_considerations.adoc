...
+
NOTE: The version difference between the original and new nodes cannot be greater than four. For example, ONTAP 9.8 and 9.12.1 is supported, however, ONTAP 9.8 and 9.13.1 and is NOT supported. 
+
