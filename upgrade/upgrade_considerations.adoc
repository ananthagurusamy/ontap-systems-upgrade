...
* If you are upgrading from an AFF A250 to an AFF A400, see xref:upgrade-aff_a250_to_aff_a400_ndu_upgrade_workflow.adoc[Upgrade AFF A250 to AFF A400 by converting to drive shelf].
