...
.2+a|* link:upgrade-by-moving-volumes-parent.html[Upgrade by moving volumes] (a nondisruptive procedure)
...
|Am I you upgrading a HA pair in a cluster with multiple HA pairs? 
