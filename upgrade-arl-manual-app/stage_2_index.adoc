...
summary: "During stage 2, you manually relocate the node1 aggregates and LIFs to node2, record node1 information, and then retire node1 on controllers running ONTAP 9.8 or later."
---
