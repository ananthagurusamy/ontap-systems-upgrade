...
summary: "Before you manually relocate node2 aggregates from node3 to node4, move the NAS data LIFs owned by node2 from node3 to node4 and verify the SAN LIFs on node4 on controllers running ONTAP 9.8 or later."
---
