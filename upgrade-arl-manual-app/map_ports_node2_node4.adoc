...
summary: "You can manually verify that the physical ports on node2 map correctly to the physical ports on node4 on controllers running ONTAP 9.8 or later."
---
