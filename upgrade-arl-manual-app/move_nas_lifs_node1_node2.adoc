...
summary: "You must manually move the NAS data LIFs owned by node1 to node2 if you have a two-node cluster, or to a third node if your cluster has more than two nodes on controllers running ONTAP 9.8 or later."
---
