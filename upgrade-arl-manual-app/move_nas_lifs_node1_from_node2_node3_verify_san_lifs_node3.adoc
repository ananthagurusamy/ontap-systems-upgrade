...
summary: "You must manually move the NAS data LIFs belonging to node1 that are currently on node2 from node2 to node3 and verify the SAN LIFs on node3 on controllers running ONTAP 9.8 or later."
---
