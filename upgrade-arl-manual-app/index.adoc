...
summary: "You can manually upgrade the original controller hardware with the replacement controller hardware, relocating the ownership of non-root aggregates on controllers running ONTAP 9.8 or later."
---
