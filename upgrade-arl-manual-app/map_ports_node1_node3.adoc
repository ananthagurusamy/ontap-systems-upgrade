...
summary: "Verify that the physical ports on node1 map correctly to node3 during a manual ARL upgrade on controllers running ONTAP 9.8 or later."
---
...
.. For ONTAP 9.8 to 9.11.1, verify that the cluster LIFs are listening on port 7700:
+
