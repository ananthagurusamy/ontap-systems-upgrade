...
summary: "You must install node3 in the rack, transfer node1's connections to node3, boot node3, and install ONTAP by using "system controller replace" commands on controllers running ONTAP 9.8 or later."
---
