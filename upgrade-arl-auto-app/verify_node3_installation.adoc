...
summary: "Verify that node1 physical ports map correctly to node3 and restore network configuration on node3 when upgrading controllers running ONTAP 9.8 or later by using `system controller replace` commands."
---
