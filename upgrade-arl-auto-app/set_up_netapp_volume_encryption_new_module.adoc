...
summary: "If required, configure the new controller module for NVE when upgrading controllers running ONTAP 9.8 or later by using `system controller replace` commands."
---
