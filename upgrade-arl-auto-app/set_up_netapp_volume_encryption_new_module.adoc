...
summary: "When you upgrade controllers running ONTAP 9.8 or later by using `system controller replace` commands, if required, you must configure the new controller module for NVE."
---
