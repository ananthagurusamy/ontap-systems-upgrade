...
. [[auto_check_4_step15]]On node4, go to the boot menu and using 22/7 and select the hidden option `boot_after_controller_replacement`.

.. At the prompt, enter node2 to reassign the disks of node2 to node4.
+
