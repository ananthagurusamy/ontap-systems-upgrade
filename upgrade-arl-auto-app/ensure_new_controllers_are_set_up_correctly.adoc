...
summary: "To confirm correct setup, you must enable the HA pair by using "system controller replace" commands on controller hardware running ONTAP 9.8 or later."
---
