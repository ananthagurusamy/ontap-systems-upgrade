...
summary: "After upgrading controller hardware running ONTAP 9.8 or later by using `system controller replace` commands, you must confirm the correct setup on the new controllers."
---
