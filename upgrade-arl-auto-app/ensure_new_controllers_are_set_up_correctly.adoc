...
summary: To ensure correct setup, you must enable the HA pair. This procedure applies to controller upgrades using "system controller replace" commands to upgrade controller hardware running ONTAP 9.8 or later
---
