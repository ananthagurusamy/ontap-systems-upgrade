...
summary: "You must install node4 in the rack, transfer node2 connections to node4, boot node4, and install ONTAP by using  `system controller replace` commands on controllers running ONTAP 9.8 or later."
---
