...
summary: "When you upgrade controllers running ONTAP 9.8 or later by using `system controller replace` commands, you must install and boot node4 and install ONTAP software."
---
