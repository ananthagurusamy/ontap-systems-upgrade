...
summary: "You can use this "system controller replace" command procedure to understand whether you can use ARL to upgrade a pair of controllers running ONTAP 9.8."
---
