...
summary: "After upgrading by using "system controller replace" commands, you must immediately configure Storage Encryption on controllers running ONTAP 9.8 or later."
---
