...
summary: "Verify that node1's NAS data LIFs on node2 are relocated from node2 to node3 when upgrading controllers running ONTAP 9.8 or later by using `system controller replace` commands."
---
