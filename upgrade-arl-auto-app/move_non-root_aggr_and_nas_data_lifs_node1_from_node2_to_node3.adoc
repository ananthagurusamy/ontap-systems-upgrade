...
summary: "Move non-root aggregates and NAS data LIFs owned by node1 from node2 to node3 by using `system controller replace` commands on controllers running ONTAP 9.8 or later."
---
