...
summary: You can install and boot node4, map the cluster and node-management ports from node2 to node4 by using "system controller replace" commands on controllers running ONTAP 9.8 or later.
---
