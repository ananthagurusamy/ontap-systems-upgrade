...
^4^Beginning with ONATP 9.10.1, ARL automated upgrade is supported from an AFF8080 system running ONTAP 9.8 or later to an AFF A900 system running 9.10.1 or later.

^5^ARL automated upgrade is not supported for FAS8020, FAS8040, AFF8020, and AFF8040 systems from ONTAP 9.11.1.
