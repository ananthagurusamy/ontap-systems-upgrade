...
summary: You can upgrade the storage controllers in an HA pair with new controllers by using "system controller replace" commands on controllers running ONTAP 9.8 or later.
---
