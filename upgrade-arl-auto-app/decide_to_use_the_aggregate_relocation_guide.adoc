...
summary: This content describes how to upgrade the storage controllers in an HA pair with new controllers. This procedure applies to controller upgrades using "system controller replace" commands to upgrade controller hardware running ONTAP 9.8 or later.
---
