...
|FAS8020^6^, FAS8040^6^, FAS8060, FAS8080
|FAS8200, FAS8300, FAS8700, FAS9000

|FAS8060^7^, FAS8080^8^
|FAS9500

|AFF8020^6^, AFF8040^6^, AFF8060, AFF8080
...
|FAS8200
|FAS8300^3^, FAS8700, FAS9000, FAS9500

|FAS8300, FAS8700, FAS9000
|FAS9500

|AFF A300
|AFF A400^3^, AFF A700, AFF A800^1^, AFF A900
...
^4^ARL automated upgrade is supported from an AFF8060 system running ONTAP 9.8P13 or later to an AFF A900 system running 9.10.1 or later.
// BURT 1480916 27-May-2022
^5^ARL automated upgrade is supported from an AFF8080 system running ONTAP 9.8P10 or later to an AFF A900 system running 9.10.1 or later.

^6^For FAS8020, FAS8040, AFF8020, and AFF8040 systems, support for ARL automated upgrade is continued for ONTAP 9.9.1 and 9.10.1 and removed from ONTAP 9.11.1.

^7^ARL automated upgrade is supported from a FAS8060 system running ONTAP 9.8P13 or later to a FAS9500 system running 9.10.1P3 or later.
// BURT 1480916 27-May-2022
^8^ARL automated upgrade is supported from a FAS8080 system running ONTAP 9.8P12 or later to a FAS9500 system running 9.10.1P3 or later.
