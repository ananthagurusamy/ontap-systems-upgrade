...
^4^The following table shows the minimum supported ONTAP version for these controller upgrade combinations. When upgrading, you must install a replacement controller with a supported ONTAP version and patch level. 
