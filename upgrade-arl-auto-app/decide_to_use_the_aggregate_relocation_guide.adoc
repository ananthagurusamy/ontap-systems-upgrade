...
|FAS8020^5^, FAS8040^5^, FAS8060, FAS8080
|FAS8200, FAS8300, FAS8700, FAS9000

|FAS8060, FAS8080^6^
|FAS9500

|AFF8020^5^, AFF8040^5^, AFF8060, AFF8080
...
^4^Beginning with ONATP 9.10.1, ARL automated upgrade is supported from an AFF8080 system running ONTAP 9.8P10 or later to an AFF A900 system running 9.10.1 or later.

^5^ARL automated upgrade is supported for FAS8020, FAS8040, AFF8020, and AFF8040 systems running ONTAP 9.9.1 and 9.10.1. Beginning with ONTAP 9.11.1, ARL automated upgrade is no longer supported.

^6^Beginning with ONATP 9.10.1P3, ARL automated upgrade is supported from a FAS8080 system running ONTAP 9.8P12 or later to a FAS9500 system running 9.10.1P3 or later.
