...
^4^Beginning with ONATP 9.10.1, you can use ARL to upgrade from an AFF8080 system running ONTAP 9.8 or later to an AFF A900 system running 9.10.1 or later.
