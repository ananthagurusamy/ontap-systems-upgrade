...
summary: "When you upgrade controllers running ONTAP 9.8 or later by using `system controller replace` commands, the system might crash – reboot, panic, or go through a power cycle ."
---
