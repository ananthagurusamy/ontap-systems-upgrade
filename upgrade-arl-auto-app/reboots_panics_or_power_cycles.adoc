...
summary: The system might crash – reboot, panic or go through a power cycle. This procedure applies to controller upgrades using "system controller replace" commands to upgrade controller hardware running ONTAP 9.8 or later.
---
