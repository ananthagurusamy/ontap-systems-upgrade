...
summary: During this "system controller replace" command procedure, the system might crash – reboot, panic or go through a power cycle on controllers running ONTAP 9.8 or later.
---
