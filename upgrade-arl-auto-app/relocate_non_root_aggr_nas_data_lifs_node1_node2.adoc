...
summary: Before you can replace node1 with node3, you must move the non-root aggregates. This procedure applies to controller upgrades using "system controller replace" commands to upgrade controller hardware running ONTAP 9.8 or later.
---
