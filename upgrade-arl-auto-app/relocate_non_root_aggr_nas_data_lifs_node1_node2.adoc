...
summary: "Before you can replace node1 with node3 on controllers running ONTAP 9.8 or later, you must move the non-root aggregates by using `system controller replace` commands."
---
