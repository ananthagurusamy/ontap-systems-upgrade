...
summary: Before you can replace node1 with node3, you must move the non-root aggregates by using "system controller replace" commands on controllers running ONTAP 9.8 or later.
---
