...
summary: "You can upgrade original controller hardware with replacement controller hardware running ONTAP 9.8 or later, relocating the ownership of non-root aggregates, by using `system controller replace` commands."
---
