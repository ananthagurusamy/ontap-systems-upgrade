...
summary: You can upgrade the original controller hardware with the replacement controller hardware, relocating the ownership of non-root aggregates by using "system controller replace" commands on controllers running ONTAP 9.8 or later.
---
