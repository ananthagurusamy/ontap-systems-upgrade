...
summary: "Verify the MetroCluster configuration and correct operation when upgrading controllers running ONTAP 9.8 or later by using `system controller replace` commands."
---
