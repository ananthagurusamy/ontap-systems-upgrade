...
summary: "You can verify the health of the MetroCluster configuration using `system controller replace` commands on controllers running ONTAP 9.8 or later."
---
