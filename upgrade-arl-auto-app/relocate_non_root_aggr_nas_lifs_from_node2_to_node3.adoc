...
summary: "Before you can replace node2 with node4, you must relocate the non-root aggregates that are owned by node2 to node3 by using "system controller replace" commands on controllers running ONTAP 9.8 or later."
---
