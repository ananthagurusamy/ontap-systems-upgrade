...
summary: You can nondisruptively upgrade the controller hardware on a pair of nodes by using "system controller replace" commands on controllers running ONTAP 9.8 or later.
---
