...
summary: "You can nondisruptively upgrade the controller hardware on a pair of nodes running ONTAP 9.8 by using "system controller replace" commands on controllers running ONTAP 9.8 or later."
---
