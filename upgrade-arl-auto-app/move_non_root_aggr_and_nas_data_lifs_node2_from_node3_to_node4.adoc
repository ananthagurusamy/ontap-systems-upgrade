...
summary: "Move non-root aggregates and NAS data LIFs owned by node2 from node3 to node4 by using `system controller replace` commands on controllers running ONTAP 9.8 or later."
---
