...
summary: If node3 has onboard FC ports, onboard unified target adapter (UTA/UTA2) ports, or a UTA/UTA2 card. This procedure applies to controller upgrades using "system controller replace" commands running ONTAP 9.8 or later.
---
