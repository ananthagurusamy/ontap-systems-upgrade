...
.. At the prompt, enter node1 to reassign the disks of node1 to node3.
+
...
.. Beginning with ONTAP 9.9.1 P8, when prompted, enter node2 as the name of the “ha-partner”.
+
