...
summary: "When you upgrade controllers running ONTAP 9.8 or later by using `system controller replace` commands, if node3 has onboard FC or UTA/UTA2 ports, or a UTA/UTA2 card, you must configure the settings before continuing."
---
