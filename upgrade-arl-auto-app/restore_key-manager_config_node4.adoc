...
summary: "When you upgrade controllers running ONTAP 9.8 or later by using `system controller replace` commands, you must restore key-manager configuration on node4 if you are using NVE to encrypt volumes on the system you are upgrading."
---
