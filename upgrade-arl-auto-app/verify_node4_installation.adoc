...
summary: "Verify that node2 physical ports map correctly to node4 and restore network configuration on node4 when upgrading controllers running ONTAP 9.8 or later by using `system controller replace` commands."
---
