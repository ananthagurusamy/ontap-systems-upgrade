...
summary: "When you upgrade controllers running ONTAP 9.8 or later by using `system controller replace` commands, you must relocate the node1 aggregates and LIFs and retire node1."
---
