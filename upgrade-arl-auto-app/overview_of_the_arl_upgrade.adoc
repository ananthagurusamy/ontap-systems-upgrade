...
summary: "Before you upgrade the nodes using ARL, you must understand how using "system controller replace" commands to upgrade controllers running ONTAP 9.8 or later works."
---
