...
summary: "Before you upgrade nodes running ONTAP 9.8 or later by using the `system controller replace` commands ARL procedure, you must understand how the procedure works."
---
