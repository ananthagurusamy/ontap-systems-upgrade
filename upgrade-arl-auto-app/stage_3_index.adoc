...
summary: "When you upgrade controllers running ONTAP 9.8 or later by using `system controller replace` commands, you must install and boot node3 and verify the node3 installation."
---
