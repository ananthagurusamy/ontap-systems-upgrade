...
|===
+
NOTE: *Important* Disabling of storage failover is mandatory. If you do not disable storage failover, controller upgrade failure, disruption to data access, and data loss can occur.
