To retire node2, you must shut node2 down properly and remove it from the rack or chassis. If the cluster is in a SAN environment, you also must delete the SAN LIFs.
