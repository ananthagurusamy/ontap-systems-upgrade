...
----
+
NOTE: If you are upgrading a HA pair in a cluster with multiple HA pairs, you should move Epsilon to the node of a HA pair not undergoing a controller upgrade. For example, if you are upgrading nodeA/nodeB in a cluster with the HA pair configuration nodeA/nodeB and nodeC/nodeD, you should move Epsilon to nodeC or nodeD.
