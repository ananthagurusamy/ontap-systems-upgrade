// This include file is referenced in the ontap-systems-upgrade and ontap-metrocluster repos.
...
. When the volume move to the new nodes is complete, verify that the volume is online:
+
[source,cli]
----
volume show -state
