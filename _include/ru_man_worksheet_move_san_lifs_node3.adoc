To help verify that you have the correct configuration after moving the SAN LIFs from node2 to node3, you can use the following worksheet to record the `adapter` and `switch-port` information for each LIF.
