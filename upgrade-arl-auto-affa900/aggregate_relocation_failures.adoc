...
summary: "Troubleshoot aggregate relocation failures when upgrading AFF A700 to AFF A900."
---
...
*	After Stage 4, when node2 is replaced with the AFF A900 controller module and NVRAM module.
+
