...
|AFF A220
|AFF A150
|9.10.1P13, 9.11.1P10, 9.12.1P3 and later
|AFF A200
|AFF A150
a|9.10.1P13, 9.11.1P10 and later (AFF A200 and AFF A150) 
...
NOTE: NetApp recommends, when possible, that you have the same ONTAP version on the old and the replacement system.
