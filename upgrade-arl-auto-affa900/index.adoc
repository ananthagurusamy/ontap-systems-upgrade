...
* The AFF A900 systems only support high-line power (200V-240V). If your AFF A700 system is running on low-line power (100V-140V), you must convert the AFF A700 input power before using this procedure.
