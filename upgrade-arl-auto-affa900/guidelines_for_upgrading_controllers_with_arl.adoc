...
summary: "Understand if you can use ARL to upgrade AFF A700 to AFF A900."
---
...
An AFF A700 to an AFF A900 upgrade using ARL and swapping only the controller module and the NVRAM module is the supported combination. If you have received a new AFF A900 system as a complete system, including a new chassis, refer to link:other_references.html[References] to link to the _Use "system controller replace" commands to upgrade controller hardware running ONTAP 9.8 or later_ content.
