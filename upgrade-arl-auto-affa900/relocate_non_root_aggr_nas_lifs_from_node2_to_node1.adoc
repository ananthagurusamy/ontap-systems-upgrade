...
[.lead]
Before you can replace node2 with the AFF A900 or FAS9500 controller module and the NVRAM module, you must first relocate the non-root aggregates that are owned by node2 to node1.
