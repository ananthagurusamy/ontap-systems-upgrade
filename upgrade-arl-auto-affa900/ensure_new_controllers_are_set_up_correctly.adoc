...
summary: "Verify that the HA pair is enabled, verify node1 and node2 storage access and LIF and aggregate ownership after upgrading an AFF A700 to an AFF A900."
---
