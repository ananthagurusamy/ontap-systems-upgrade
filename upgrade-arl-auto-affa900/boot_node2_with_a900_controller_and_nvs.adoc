...
[.lead]
Node2 with the replacement modules is now ready for boot up. Upgrading by swapping the system modules involves moving only the console and management connections. This section provides the steps required to boot node1 with the replacement modules for the following upgrade configurations:
