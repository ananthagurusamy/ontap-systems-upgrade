...
+
`boot_ontap menu`
.	Reassign the AFF A700 node2 disks to AFF A900 node2 by entering "22/7" and selecting the hidden option `boot_after_controller_replacement` when the node stops at the boot menu.
+
