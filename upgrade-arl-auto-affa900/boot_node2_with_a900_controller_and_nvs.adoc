...
+
Enter the passphrase and the backup information that you recorded earlier procedure. See link:manage_authentication_okm.html[Manage authentication using the Onboard Key Manager].
