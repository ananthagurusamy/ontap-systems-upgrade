...
Between entering node names at the prompt and the login prompt, the node reboots several of times to restore the environment variables, update firmware on the cards in the system, and for other ONTAP updates.
====
