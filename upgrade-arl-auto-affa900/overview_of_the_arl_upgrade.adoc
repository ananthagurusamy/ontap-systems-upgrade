...
| link:boot_node1_with_a900_controller_and_nvs.html[Stage 3: Boot node1 with the AFF A900 controller module NVRAM module]
...
| link:install_a900_nvs_and_controller_on_node2.html[Stage 5: Install the AFF A900 NVRAM module and controller module on node2]
a| .	Install the AFF A900 NVRAM module and controller module on node2
.	Netboot node2
...
| link:boot_node2_with_a900_controller_and_nvs.html[Stage 6: Boot node2 with the AFF A900 controller module and NVRAM module]
