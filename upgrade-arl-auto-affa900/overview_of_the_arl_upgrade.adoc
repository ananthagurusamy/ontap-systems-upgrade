...
a| . Boot node1 with the AFF A900 or FAS9500 controller and NVRAM modules
...
| link:install_a900_nvs_and_controller_on_node2.html[Stage 5: Install the AFF A900 or FAS9500 NVRAM and controller modules on node2]
a| .	Install the AFF A900 or FAS9500 NVRAM and controller modules on node2
.	Netboot node2
