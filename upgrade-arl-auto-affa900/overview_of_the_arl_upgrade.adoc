...
. Retire node1
.	Remove the AFF A700 controller module and NVRAM
.	Install the AFF A900 NVRAM and controller module on node1
.	Netboot node1
...
|Stage 3: Boot node1 with the AFF A900 controller module NVRAM
a| . Boot node1 with the AFF A900 controller module and NVRAM
...
|Stage 5: Install the AFF A900 NVRAM and controller module on node2
a| .	Install the AFF A900 NVRAM and controller module on node2
.	Netboot node2
...
|Stage 6: Boot node2 with the AFF A900 controller module and NVRAM
a| .	Boot node2 with the AFF A900 controller module and NVRAM
