...
a| . Verify the upgrade hardware
. Run prechecks to verify that you can perform the operation
...
. Manage authentication by using a Key Management Operability Protocol (KMIP) server
...
| link:relocate_non_root_aggr_and_nas_data_lifs_node1_node2.html[Stage 2: Relocate resources from node1 and retire AFF A700 or FAS9000 node1]
a| .	Relocate non-root aggregates and NAS data LIFs owned by node1 to node2
. Relocate failed or vetoed aggregates
. Retire node1
.	Remove the AFF A700 or FAS9000 controller module and NVRAM module
.	Install the AFF A900 or FAS9500 NVRAM module and controller module on node1
.	Netboot node1
...
| link:boot_node1_with_a900_controller_and_nvs.html[Stage 3: Boot node1 with the AFF A900 or FAS9500 controller module and NVRAM module]
a| . Boot node1 with the AFF A900 or FAS9500 controller module and NVRAM module
...
| link:relocate_non_root_aggr_nas_lifs_from_node2_to_node1.html[Stage 4: Relocate resources from node2 and retire node2]
...
| link:install_a900_nvs_and_controller_on_node2.html[Stage 5: Install the AFF A900 or FAS9500 NVRAM module and controller module on node2]
a| .	Install the AFF A900 or FAS9500 NVRAM module and controller module on node2
.	Netboot node2
...
| link:boot_node2_with_a900_controller_and_nvs.html[Stage 6: Boot node2 with the AFF A900 or FAS9500 controller module and NVRAM module]
a| .	Boot node2 with the AFF A900 or FAS9500 controller module and NVRAM module
...
| link:ensure_new_controllers_are_set_up_correctly.html[Stage 7: Complete the upgrade]
