...
summary: Move the non-root aggregates and NAS data LIFs from node1 to node2 before replacing node1 with the AFF A900 controller module and the NVRAM module.
---
