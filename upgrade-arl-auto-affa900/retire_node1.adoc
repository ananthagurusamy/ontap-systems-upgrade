...
* From the AFF A700, do NOT move the coredump device from the AFF A700 NVRAM module to the AFF A900 NVRAM module.
* From the FAS9000, move all flash cache modules installed in the FAS9000 NVRAM module to the FAS9500 NVRAM module.
