...
You must install the AFF A900 or FAS9500 NVRAM module and controller module that you received for the upgrade on node1. On the AFF A900, do NOT move the coredump devices from the AFF A700 NVRAM module to the AFF A900 NVRAM module.  On the FAS9000, move all flash cache modules in slot 6 to the FAS9500 NVRAM module.
