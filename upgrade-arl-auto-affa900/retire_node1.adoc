...
[.lead]
To retire node1, resume the automated operation to disable the HA pair with node2 and shut down node1 correctly. You must later remove the AFF A700 or the FAS9000 controller module and the NVRAM module from the node1 chassis and then install the AFF A900 or the FAS9500 NVRAM module and controller module on node1.
...
.	If you are using any add-on modules as coredump devices on the AFF A700 or FAS9000 NVRAM module, do NOT transfer them to the AFF A900 or FAS9500 NVRAM module.

== Install the AFF A900 or FAS9500 NVRAM module and controller module on node1
You must install the AFF A900 or FAS9500 NVRAM module and controller module that you received for the upgrade on node1.
