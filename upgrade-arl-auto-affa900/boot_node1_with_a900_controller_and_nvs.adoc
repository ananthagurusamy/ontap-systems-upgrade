...
^1^ Upgrading by the swapping the controller module involves moving all connections from the old to the replacement controller module.
^2^ Upgrading by swapping the controller and NVRAM modules involves moving only the console and management connections.
