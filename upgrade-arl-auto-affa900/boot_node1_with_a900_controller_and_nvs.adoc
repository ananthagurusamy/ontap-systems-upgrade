...
+
`boot_ontap menu`
.	The node stops at the boot menu. Enter "22/7" and select the hidden option `boot_after_controller_replacement`. To reassign the AFF A700 or FAS9000 node1 disks to AFF A900 or FAS9500 node1, at the prompt, enter the actual node name of node1. Use the following example as a reference:
+
----
