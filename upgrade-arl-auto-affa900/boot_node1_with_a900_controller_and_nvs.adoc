...
+
NOTE: If the system reports `diskown.errorDuringIO:error` errors, you must reset the bootargs in <<aff_a900_boot_node1,Step 1>> and run the `boot_ontap` command.
