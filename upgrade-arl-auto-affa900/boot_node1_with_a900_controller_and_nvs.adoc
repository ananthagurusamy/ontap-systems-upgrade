...
+
`boot_ontap menu`
.	The node stops at the boot menu. Enter "22/7" and select the hidden option `boot_after_controller_replacement`. To reassign the node1 disks from the AFF A700 to AFF A900 or from FAS9000 to FAS9500, at the prompt, enter the actual node name of node1. Use the following example as a reference:
+
----
