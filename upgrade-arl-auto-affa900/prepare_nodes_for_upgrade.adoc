...
+
NOTE: If NetApp Volume Encryption using Onboard Key Manager is in use, keep the key-manager passphrase ready to complete the key manager resync later in the procedure.
