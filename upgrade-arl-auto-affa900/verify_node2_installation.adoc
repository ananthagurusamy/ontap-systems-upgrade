...
[.lead]
You must verify the node2 installation with the AFF A900 or FAS9500 controller and NVRAM modules. Because there is no change to physical ports, you are not required to map the physical ports from the old node2 to the replacement node2.
