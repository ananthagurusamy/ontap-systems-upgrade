...
summary: "Verify that node4 joins the quorum, re-create node1's VLANs, interface groups, and broadcast domains and restore key-manager configuration when upgrading controllers running ONTAP 9.5 to 9.7 by using `system controller replace` commands."
---
