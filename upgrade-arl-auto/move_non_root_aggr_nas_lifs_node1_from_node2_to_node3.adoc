...
summary: "Move node1 NAS data LIFs on node2 from node2 to node3 when upgrading controllers running ONTAP 9.5 to 9.7 by using `system controller replace` commands."
---
