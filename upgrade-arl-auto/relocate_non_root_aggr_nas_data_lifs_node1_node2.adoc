...
summary: "Move non-root aggregates and NAS data LIFs from node1 to node2 and move node1s resources to node3 when upgrading controllers running ONTAP 9.5 to 9.7 by using system controller replace commands".
---
// removed single quote, https://github.com/NetAppDocs/docs-help/discussions/367
