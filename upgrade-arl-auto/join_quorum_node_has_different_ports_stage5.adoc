...
summary: "Confirm that the new node joins the quorum during stage 5 when upgrading controllers running ONTAP 9.5 to 9.7 by using `system controller replace` commands."  
---
