...
summary: "Prepare the nodes and run a series of prechecks when upgrading controllers running ONTAP 9.5 to 9.7 by using `system controller replace` commands."
---
