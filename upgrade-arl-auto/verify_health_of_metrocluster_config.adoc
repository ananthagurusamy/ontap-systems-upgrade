...
summary: "Verify the MetroCluster configuration and correct operation when upgrading controllers running ONTAP 9.5 to 9.7 by using `system controller replace` commands."
---
