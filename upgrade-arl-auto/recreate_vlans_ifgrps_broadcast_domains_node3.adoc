...
summary: "Re-create node1 VLANs, interface groups, and broadcast domains on node3 when upgrading controllers running ONTAP 9.5 to 9.7 by using `system controller replace` commands."
---
